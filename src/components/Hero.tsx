...
const Hero = () => {
  return (
    <section id="home" className="relative h-screen bg-red-900 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('src/public/cu.jpg')",
        }}
      ></div>
      ...
      <div className="container mx-auto px-4 h-full flex items-center relative z-20">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <a
              href="#registration"
              className="px-8 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-md transition-colors duration-300 text-center"
            >
              Register Now
            </a>
            <a
