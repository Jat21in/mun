    ...
    <section id="faculty" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-red-600 mb-4">Faculty & Secretariat</h2>
        ...
        {/* Faculty Advisors */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-red-600 mb-8 text-center">Faculty Advisors</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {facultyMembers.map((member) => (
              ...
              >
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-red-600 mb-1">{member.name}</h4>
        ...
        {/* Secretariat */}
        <div>
          <h3 className="text-2xl font-bold text-red-600 mb-8 text-center">Secretariat</h3>
            ...
            {secretariatMembers.map((member) => (
              ...
              >
                ...
                <div className="w-2/3 p-4">
                  <h4 className="text-lg font-bold text-red-600 mb-1">{member.name}</h4>
